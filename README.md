...
python3 train_self_supervised.py -d reddit --use_memory --prefix tgn-attn-reddit --n_runs 10
```
...
python3 train_supervised.py --use_memory --prefix tgn-attn --n_runs 10

# TGN-attn-reddit: self-supervised learning on the reddit dataset
python3 train_supervised.py -d reddit --use_memory --prefix tgn-attn-reddit --n_runs 10
```
